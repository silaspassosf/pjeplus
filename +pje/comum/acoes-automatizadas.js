...
function criarFiltrosAA(container) {
	...
	filtro.appendChild(criarFiltro('ANEXAR DOCUMENTOS','maisPje-icone paperclip maisPje-t20', filtro));
	filtro.appendChild(criarFiltro('INTIMAÇÃO/EXPEDIENTE','maisPje-icone maisPje-envelope maisPje-t20', filtro));
	filtro.appendChild(criarFiltro('AUTOGIGS','maisPje-icone maisPje-tag maisPje-t20', filtro));
	filtro.appendChild(criarFiltro('DESPACHO','maisPje-icone maisPje-gavel maisPje-t20', filtro));
	filtro.appendChild(criarFiltro('MOVIMENTOS','maisPje-icone hand-paper maisPje-t20', filtro));
	filtro.appendChild(criarFiltro('CHECKLIST','maisPje-icone maisPje-check-solid maisPje-t20', filtro));
	filtro.appendChild(criarFiltro('NOMEAR PERITO','maisPje-icone user-md maisPje-t20', filtro));
	filtro.appendChild(criarFiltro('CÁLCULOS DO PROCESSO','maisPje-icone maisPje-calculator maisPje-t20', filtro));
	filtro.appendChild(criarFiltro('RETIFICAR AUTUAÇÃO','maisPje-icone pencil-alt maisPje-t20', filtro));
	filtro.appendChild(criarFiltro('LANÇAR MOVIMENTOS','maisPje-icone plus-square maisPje-t20', filtro));
	filtro.appendChild(criarFiltro('CLICAR EM','maisPje-icone mouse-pointer-solid maisPje-t20', filtro));
	filtro.appendChild(criarFiltro('VARIADOS','maisPje-icone tablets-solid maisPje-t20', filtro));
