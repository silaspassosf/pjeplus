        ...
        if (window.location.href.indexOf('/aud/') === -1) return;
            ...
            var perfis = {
                otavio: {
                    ...
                    ], direito das partes, mas faculdade do juiz.</p><p style=\"text-align:justify;text-indent:3cm;\">A fortiori, em casos como o em comento, em que há testemunhas a serem ouvidas, também se mostra dispensável a oitiva das partes.</p><p style=\"text-align:justify;text-indent:3cm;\">Dessa forma, a decisão acerca da realização, ou não, dos depoimentos pessoais insere-se no âmbito do poder de condução do processo atribuído ao magistrado, não se tratando de prerrogativa das partes.</p><p style=\"text-align:justify;text-indent:3cm;\">Indefiro, portanto, o pleito de oitiva das partes.</p><p style=\"text-align:justify;text-indent:3cm;\">Protestos das partes.</p>"}, {"t": "revelia", "h": "<p style=\"text-align:justify;text-indent:3cm;\">Diante da ausência injustificada da reclamada, aplico-lhe a pena de revelia e confissão.</p>"}],
