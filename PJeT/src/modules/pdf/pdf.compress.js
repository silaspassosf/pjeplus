...
(function () {
    ...
    console.log('[PJeT][pdf.compress] Módulo carregado.');
    ...
    async function _comprimirPdf(originalBytes) {
        ...
        // Adaptação extensão (MV3): worker empacotado via browser.runtime.getURL;
        // CDN apenas como fallback fora do contexto de extensão.
