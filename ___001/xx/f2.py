"""
f2.py - Script de Teste Rápido (xx) - ATO BLOQ
===================================================
...
URL_NAVEGACAO = "https://pje.trt2.jus.br/pjekz/processo/6563138/detalhe"
...
from PEC.anexos.anexos_extracao import extrair_numero_processo_da_url
from PEC.anexos.anexos_wrappers import carta_wrapper


def testar_juntada_ecarta(driver_pje):
    """Executa juntada eCarta usando dados ja salvos no clipboard."""
    print("[TESTE] Executando juntada eCarta...")
    numero_processo = extrair_numero_processo_da_url(driver_pje)
    return carta_wrapper(driver_pje, numero_processo=numero_processo, debug=True)


# Lista de funcoes e kwargs para teste
TESTE_FUNCOES = [
    {"nome": "testar_juntada_ecarta", "func": testar_juntada_ecarta, "kwargs": {}},
]
...
def main():
    ...
    try:
        print("=" * 80)
        print("F2.PY - SCRIPT DE TESTE RÁPIDO")
        print("=" * 80)
