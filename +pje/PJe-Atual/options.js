...
function configurarModoLGPD(modoLGPD) {
	...
	if (modoLGPD) {
		icone.className = 'maisPje-icone lgpd-on maisPje-t20';
		botao.setAttribute('data-tooltip','Modo LGPD Ativado');
		botao.setAttribute('aria-pressed','true');
	} else {
		icone.className = 'maisPje-icone lgpd-off maisPje-t20';
...
async function montar_modulo2() {
	...
	bt_excluirTodos.className = "maisPje-icone trash-alt maisPje-t16";
	...
	let teste = [].map.call(listaModulo2_temp,function(item) {
		...
		bt_editar.className = "maisPje-icone maisPjeEdit maisPje-t16";
		...
		bt_excluir.className = "maisPje-icone trash-alt maisPje-t16";
	...
	switch (convenio) {
		case 'sisbajud':
			...
			let { value: resultsisbajud } = await Swal.fire({
				...
				html:
					...
					aaSisbajud +
					'</button><button id="apagar-escolherAAVinculoAASISBAJUD" data-tooltip="Remover Ação Automatizada após PROTOCOLO da ordem de INCLUSÃO" aria-label="Remover Ação Automatizada após PROTOCOLO da ordem" style="margin-left: 15px; width: 40px; height: 40px; border: none; background: transparent; cursor: pointer;"><i class="maisPje-icone trash-alt maisPje-t20" style="background-color: lightgray; vertical-align: middle;"></i></button></div>' +
		...
		case 'cnib':
			...
			let { value: resultcnib } = await Swal.fire({
				...
				html:
					...
					'</button><button id="apagar-escolherAAVinculoAACNIB1" data-tooltip="Remover Ação Automatizada após PROTOCOLO da ordem de INCLUSÃO" aria-label="Remover Ação Automatizada após PROTOCOLO da ordem" style="margin-left: 15px; width: 40px; height: 40px; border: none; background: transparent; cursor: pointer;"><i class="maisPje-icone trash-alt maisPje-t20" style="background-color: lightgray; vertical-align: middle;"></i></button>' +
					...
					'</button><button id="apagar-escolherAAVinculoAACNIB2" data-tooltip="Remover Ação Automatizada após PROTOCOLO da ordem de EXCLUSÃO" aria-label="Remover Ação Automatizada após PROTOCOLO da ordem" style="margin-left: 15px; width: 40px; height: 40px; border: none; background: transparent; cursor: pointer;"><i class="maisPje-icone trash-alt maisPje-t20" style="background-color: lightgray; vertical-align: middle;"></i></button>' +
					'</div><br aria-hidden="true">' +
					'</fieldset>' +
		...
		case 'ccs':
			...
			let { value: resultccs } = await Swal.fire({
				...
				html:
					...
					aaCCS1 +
					'</button><button id="apagar-escolherAAVinculoAACCS1" data-tooltip="Remover Ação Automatizada após PROTOCOLO da ordem de INCLUSÃO" aria-label="Remover Ação Automatizada para executar após o protocolo da ordem CCS" style="margin-left: 15px; width: 40px; height: 40px; border: none; background: transparent; cursor: pointer;"><i class="maisPje-icone trash-alt maisPje-t20" style="background-color: lightgray; vertical-align: middle;"></i></button></div>' +
					...
					aaCCS2 +
					'</button><button id="apagar-escolherAAVinculoAACCS2" data-tooltip="Remover Ação Automatizada após DOWNLOAD da resposta" aria-label="Remover Ação Automatizada para executar após o DOWNLOAD da resposta" style="margin-left: 15px; width: 40px; height: 40px; border: none; background: transparent; cursor: pointer;"><i class="maisPje-icone trash-alt maisPje-t20" style="background-color: lightgray; vertical-align: middle;"></i></button></div>',
		...
		case 'prevjud':
			...
			let { value: resultprevjud } = await Swal.fire({
				...
				html:
					...
					aaPrevjud +
					'</button><button id="apagar-escolherAAVinculoAAPrevjud" data-tooltip="Remover Ação Automatizada após PROTOCOLO da ordem" aria-label="Remover Ação Automatizada após PROTOCOLO da ordem" style="margin-left: 15px; width: 40px; height: 40px; border: none; background: transparent; cursor: pointer;"><i class="maisPje-icone trash-alt maisPje-t20" style="background-color: lightgray; vertical-align: middle;"></i></button></div>' +
					'<div style="display: grid;grid-template-columns: auto 2% 40% 3%;align-items: center;margin-top: 15px;text-align: left;">' +
					...
					aa2Prevjud +
					'</button>'+
					'<button id="apagar-escolherAAVinculoAA2Prevjud"  data-tooltip="Remover Ação Automatizada após CONSULTA da ordem" aria-label="Remover Ação Automatizada após CONSULTA da ordem" style="margin-left: 15px; width: 40px; height: 40px; border: none; background: transparent; cursor: pointer;"><i class="maisPje-icone trash-alt maisPje-t20" style="background-color: lightgray; vertical-align: middle;"></i></button></div>',
		...
		case 'saj':
            ...
            let { value: resultsaj } = await Swal.fire({
                ...
                '</button><button id="apagar-escolherAAVinculoSAJ1" data-tooltip="Remover Ação Automatizada após PROTOCOLO da ordem de INCLUSÃO" aria-label="Remover Ação Automatizada para executar após o protocolo da ordem CCS" style="margin-left: 15px; width: 40px; height: 40px; border: none; background: transparent; cursor: pointer;"><i class="maisPje-icone trash-alt maisPje-t20" style="background-color: lightgray; vertical-align: middle;"></i></button></div>' +
                ...
                '</button><button id="apagar-escolherAAVinculoSAJ2" data-tooltip="Remover Ação Automatizada após o DOWNLOAD da resposta" aria-label="Remover Ação Automatizada para executar após o DOWNLOAD da resposta" style="margin-left: 15px; width: 40px; height: 40px; border: none; background: transparent; cursor: pointer;"><i class="maisPje-icone trash-alt maisPje-t20" style="background-color: lightgray; vertical-align: middle;"></i></button>' +
...
async function modalEditorEditar(elemento_pai, tipo, id) {
	if (tipo == "anexar") {
		...
		const { value: result } = await Swal.fire({
			...
			'<div id="apagar_config_comandosEspeciaisComunicacao" data-tooltip="Apagar"><i class="maisPje-icone trash-alt maisPje-t16" style="padding: 0px 5px; background-color: #545454;pointer-events: none;" pos="0"></i></div></div>' +
			'</div>' +
		...
		const { value: result } = await Swal.fire({
			...
			'<div id="apagar_config_comandosEspeciaisDespacho" data-tooltip="Apagar"><i class="maisPje-icone trash-alt maisPje-t16" style="padding: 0px 5px; background-color: #545454;pointer-events: none;" pos="0"></i></div></div>' +
			'</div>' +
...
function gerarListaDeVinculos(lista_de_vinculos, tamanho = 10) {
	...
	for (let i = 0; i < tamanho; i++) {
		...
		html += '<div style="display: grid;grid-template-columns: 10% 80% 5% 5%;margin: 10px 0;">' +
				...
				'<i class="maisPje-icone trash-alt maisPje-t20" style="background-color: lightgray; vertical-align: middle;"></i></button>' +
                '</div>';
	}
...
function montarNovidades(autoplay, novidades) {
	...
	i.className = "maisPje-icone novidades-list maisPje-t16";
...
document.body.addEventListener("click", async function (event) {
	...
	if (event.target.className.includes("maisPje-icone question-circle") || event.target.className.includes("duvidas")) {
		let msg = '';
		...
		switch (event.target.id) {
			...
			case 'modulo1_4':
				...
				break
			case 'modulo1_5':
				msg = 'Se selecionado, ao abrir a Janela DETALHES, irá guardar os dados do processo na memória da extensão para uso futuro. É o mesmo efeito de clicar no botão (<i class="maisPje-icone address-card maisPje-t20" style="vertical-align: bottom; cursor: default;"></i>)<br><br>Para visualizar os dados clique com o botão direito do mouse em qualquer lugar da tela e selecione o submenu "maisPje".';
				break
			case 'modulo1_6':
	...
	} else if (event.target.className.includes("maisPje-icone maisPje-video") || event.target.className.includes("video-explicativo")) {
		let video = '';
		switch (event.target.id) {
			case 'modulo1_1':
