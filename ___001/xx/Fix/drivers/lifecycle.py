...
def criar_driver_PC(headless: bool = False) -> webdriver.Firefox:
    ...
    - Cache otimizado
    - Anti-throttling (evita lentidão em background)
    ...
    Exemplo:
        ...
        # Driver headless
        driver = criar_driver_PC(headless=True)
    
    Notas:
        - Requer Firefox Developer Edition instalado em:
          C:\\Program Files\\Firefox Developer Edition\\firefox.exe
        - Implicit wait configurado para 10 segundos
    """
    options = Options()
    if headless:
...
def criar_driver_VT(headless: bool = False) -> webdriver.Firefox:
    ...
    Notas:
        - Usa perfil específico do usuário: 13zemix3.default-release-1623328432485
