...
async function iniciar() {
    browser.storage.local.get(['processo_memoria','trt','oj']).then(function(result){
...
async function criarPainelComDadosDaMemoria(processo_memoria) {
    ...
    async function popularDomicilioEndereco() {

        let itens = await esperarColecao('domicilio');
        console.log('teta: ' + itens.length)
        if (itens) {
