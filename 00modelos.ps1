...
# ---- BASE (GROQ+Qwen 2.5) ----
# Defina OPENAI_API_KEY no seu perfil PowerShell ou variável de ambiente do sistema
...
function qwen {
  ...
  Write-Host "⚡ Local - qwen2.5-7b-instruct" -ForegroundColor Green
}
function use-plus {
    # $env:OPENAI_API_KEY="sua-chave-aqui"
...
function use-max {
    ...
    $env:OPENAI_MODEL="minimaxai/minimax-m2.7"
    Write-Host "💻 MiniMax2.7 - NVidiaBuild" -ForegroundColor Magenta
}
