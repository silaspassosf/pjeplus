...
def extrair_numero_processo_pec(driver):
    return extrair_numero_processo_unificado(driver, 'pec')

def verificar_acesso_negado_pec(driver):
    return verificar_acesso_negado_unificado(driver, 'pec')

def processo_ja_executado_pec(numero_processo, progresso):
    return processo_ja_executado_unificado(numero_processo, progresso)

def marcar_processo_executado_pec(numero_processo, progresso):
    marcar_processo_executado_unificado('pec', numero_processo, progresso, sucesso=True)
