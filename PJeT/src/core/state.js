...
// ── Portado de Script/core/state.js ─────────────────────────────
// CleanupRegistry, AsyncRunner e PJeState singleton.
// Sem GM_*, sem imports — expõe tudo em window.*
...
// dispose() é chamado pelo loader a cada pushState.
