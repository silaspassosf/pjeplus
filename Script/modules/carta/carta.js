// carta.js — eCarta Bookmarklet Enhanced (módulo PJe Tools Pro)
// =====================================================================
// Porta 1:1 do bookmarklet "eCarta — Últimas / Antigas" com auditoria de
// falsos positivos: nos rastreamentos marcados como "Entregue ao
// destinatário", consulta o histórico (GET + POST JSF parcial) e corrige
// o relatório quando houve devolução ao remetente.
//
// Página-alvo:
...
(function () {
    ...
    // ── Gate: só atua na consulta de processo do eCarta ──
    if (!window.location.href.includes('/eCarta-web/consultarProcesso.xhtml')) return;
    ...
    console.log('[PjeCarta] Botões Últimas/Antigas injetados (eCarta):', window.location.href);

    // API pública (convenção: window.NomeModulo = {...})
    window.PjeCarta = {
        parseTabela: parseTabela,
        auditarRastreio: auditarRastreio,
