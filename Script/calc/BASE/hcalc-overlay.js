            ...
            deposito.innerHTML = `
                ...
                <div style="margin-top: 8px;">
                    ...
                    <div id="cumprimento-transferidos-campos-${idx}" class="hidden" style="margin-top: 6px;">
                        <div class="row">
                            <input type="text" id="cumprimento-id-transferencia-${idx}" placeholder="Id da Transferência">
                        </div>
                        <div class="row" style="margin-top: 5px;">
                            <label style="font-size: 11px;"><input type="radio" name="cumprimento-tipo-liberacao-${idx}" value="direta" checked> Liberação direta</label>
