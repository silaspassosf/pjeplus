...
// @require      https://raw.githubusercontent.com/silaspassosf/pjeplus/main/Script/modules/lista/lista.check.js?v=2.1.34
...
(async function () {
    'use strict';
    console.log('[Loader] PJe Tools Pro v2.1.34 loaded');
