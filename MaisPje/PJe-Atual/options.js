...
async function checarVariaveis(restaurar=false) {
	return new Promise(async resolve => {
		...
		opcoes.prazoResponsavel = typeof(opcoes.prazoResponsavel) == "undefined" ? "" : opcoes.prazoResponsavel;
		opcoes.atividadeResponsavel = typeof(opcoes.atividadeResponsavel) == "undefined" ? "" : opcoes.atividadeResponsavel;
		opcoes.atalhosPlugin = typeof(opcoes.atalhosPlugin) == "undefined" ? "SISBAJUD:https://sisbajud.cloud.pje.jus.br/|Caged:https://caged.maisemprego.mte.gov.br/caged|CCS:https://www3.bcb.gov.br/ccs/dologin|Celesc:http://consumidor.celesc.com.br:8895/index.php/acesso|Cnib:https://www.indisponibilidade.org.br/autenticacao/|Honor\u00e1rios:http://www2.trt12.jus.br/ajg/intranet/entrada.asp|Intranet:https://intranet.trt12.jus.br/|Renajud:https://renajud.denatran.serpro.gov.br/renajud/login.jsf|Serasajud:https://sitenet05cert.serasa.com.br/SerasaJudicial/default.aspx|Siel:https://apps.tre-sc.jus.br/siel/index.php" : opcoes.atalhosPlugin;
		opcoes.gigsMonitorDetalhes = typeof(opcoes.gigsMonitorDetalhes) == "undefined" ? 0 : opcoes.gigsMonitorDetalhes;
		opcoes.gigsMonitorTarefas = typeof(opcoes.gigsMonitorTarefas) == "undefined" ? 0 : opcoes.gigsMonitorTarefas;
		opcoes.gigsMonitorGigs = typeof(opcoes.gigsMonitorGigs) == "undefined" ? 0 : opcoes.gigsMonitorGigs;
		opcoes.lista_monitores = typeof(opcoes.lista_monitores) == "undefined" ? [{"left":0,"top":0,"width":0,"height":0}] : opcoes.lista_monitores;
		opcoes.lista_monitores = opcoes.lista_monitores.length < 1 ? [{"left":0,"top":0,"width":0,"height":0}] : opcoes.lista_monitores;
		opcoes.gigsAbrirGigs = typeof(opcoes.gigsAbrirGigs) == "undefined" ? 0 : opcoes.gigsAbrirGigs;
		opcoes.gigsAbrirDetalhes = typeof(opcoes.gigsAbrirDetalhes) == "undefined" ? 0 : opcoes.gigsAbrirDetalhes;
		opcoes.gigsAbrirTarefas = typeof(opcoes.gigsAbrirTarefas) == "undefined" ? 0 : opcoes.gigsAbrirTarefas;
		opcoes.gigsApreciarPeticoes = typeof(opcoes.gigsApreciarPeticoes) == "undefined" ? 0 : opcoes.gigsApreciarPeticoes;
		opcoes.gigsApreciarPeticoes2 = typeof(opcoes.gigsApreciarPeticoes2) == "undefined" ? 0 : opcoes.gigsApreciarPeticoes2;
		opcoes.gigsApreciarPeticoes3 = typeof(opcoes.gigsApreciarPeticoes3) == "undefined" ? 0 : opcoes.gigsApreciarPeticoes3;
		opcoes.gigsOcultarChips = typeof(opcoes.gigsOcultarChips) == "undefined" ? 0 : opcoes.gigsOcultarChips;
		...
		opcoes.aaAutogigs = typeof(opcoes.aaAutogigs) == "undefined" ? [] : opcoes.aaAutogigs;
		opcoes.aaDespacho = typeof(opcoes.aaDespacho) == "undefined" ? [] : opcoes.aaDespacho;
		...
		opcoes.gigsDetalhesWidth = typeof(opcoes.gigsDetalhesWidth) == "undefined" ? window.screen.availWidth : opcoes.gigsDetalhesWidth;
		opcoes.gigsDetalhesHeight = typeof(opcoes.gigsDetalhesHeight) == "undefined" ? window.screen.availHeight : opcoes.gigsDetalhesHeight;
		opcoes.gigsTarefaLeft = typeof(opcoes.gigsTarefaLeft) == "undefined" ? window.screen.availLeft : opcoes.gigsTarefaLeft;
		opcoes.gigsTarefaTop = typeof(opcoes.gigsTarefaTop) == "undefined" ? window.screen.availTop : opcoes.gigsTarefaTop;
		opcoes.gigsTarefaWidth = typeof(opcoes.gigsTarefaWidth) == "undefined" ? window.screen.availWidth : opcoes.gigsTarefaWidth;
		opcoes.gigsTarefaHeight = typeof(opcoes.gigsTarefaHeight) == "undefined" ? window.screen.availHeight : opcoes.gigsTarefaHeight;
		opcoes.gigsGigsLeft = typeof(opcoes.gigsGigsLeft) == "undefined" ? window.screen.availLeft : opcoes.gigsGigsLeft;
		opcoes.gigsGigsTop = typeof(opcoes.gigsGigsTop) == "undefined" ? window.screen.availTop : opcoes.gigsGigsTop;
		opcoes.gigsGigsWidth = typeof(opcoes.gigsGigsWidth) == "undefined" ? window.screen.availWidth : opcoes.gigsGigsWidth;
		opcoes.gigsGigsHeight = typeof(opcoes.gigsGigsHeight) == "undefined" ? window.screen.availHeight : opcoes.gigsGigsHeight;
		opcoes.atalhosDetalhes = typeof(opcoes.atalhosDetalhes) == "undefined" ? [true,true,true,false,true,false,true,false,false,true,false,false,true,false,true,false,false,false,true,false,false,true,false,false,true] : opcoes.atalhosDetalhes;
		opcoes.processo_memoria = typeof(opcoes.processo_memoria) == "undefined" ? "" : opcoes.processo_memoria;
		...
		opcoes.tempAR = typeof(opcoes.tempAR) == "undefined" ? "" : opcoes.tempAR;
		opcoes.tempBt = typeof(opcoes.tempBt) == "undefined" ? [] : opcoes.tempBt;
		opcoes.tempAAEspecial = typeof(opcoes.tempAAEspecial) == "undefined" ? [] : opcoes.tempAAEspecial;
		opcoes.tempF2 = typeof(opcoes.tempF2) == "undefined" ? "" : opcoes.tempF2;
		opcoes.tempF3 = typeof(opcoes.tempF2) == "undefined" ? "" : opcoes.tempF3;
		opcoes.tempAuto = typeof(opcoes.tempAuto) == "undefined" ? 10 : opcoes.tempAuto;
		opcoes.monitorGIGS = typeof(opcoes.monitorGIGS) == "undefined" ? [] : opcoes.monitorGIGS;
		opcoes.pjExtension_depositos = typeof(opcoes.pjExtension_depositos) == "undefined" ? [] : opcoes.pjExtension_depositos;
		opcoes.concordo = typeof(opcoes.concordo) == "undefined" ? false : opcoes.concordo;
		opcoes.extensaoAtiva = typeof(opcoes.extensaoAtiva) == "undefined" ? false : opcoes.extensaoAtiva;
		opcoes.modulo2 = typeof(opcoes.modulo2) == "undefined" ? [] : opcoes.modulo2;
		opcoes.modulo2 = await inserirFaseModulo2();		
		opcoes.sisbajud = typeof(opcoes.sisbajud) == "undefined" ? {juiz: '', vara: '', cnpjRaiz: '', teimosinha: '', contasalario: '', naorespostas: '', valor_desbloqueio: '', banco_preferido: '', agencia_preferida: '', preencherValor: '', confirmar: '', executarAAaoFinal: '', salvarEprotocolar: ''} : opcoes.sisbajud;
		opcoes.sisbajud.juiz = typeof(opcoes.sisbajud.juiz) == "undefined" ? "" : opcoes.sisbajud.juiz;
		opcoes.sisbajud.vara = typeof(opcoes.sisbajud.vara) == "undefined" ? "" : opcoes.sisbajud.vara;
		opcoes.sisbajud.cnpjRaiz = typeof(opcoes.sisbajud.cnpjRaiz) == "undefined" ? "não" : opcoes.sisbajud.cnpjRaiz;
		...
		opcoes.sisbajud.preencherValor = typeof(opcoes.sisbajud.preencherValor) == "undefined" ? "não" : opcoes.sisbajud.preencherValor;
		opcoes.sisbajud.confirmar = typeof(opcoes.sisbajud.confirmar) == "undefined" ? "não" : opcoes.sisbajud.confirmar;
		...
		opcoes.modulo8 = typeof(opcoes.modulo8) == "undefined" ? [] : opcoes.modulo8;
		opcoes.modulo10 = typeof(opcoes.modulo10) == "undefined" ? [] : opcoes.modulo10;
		opcoes.modulo10_juntadaMidia = typeof(opcoes.modulo10_juntadaMidia) == "undefined" ? [false,''] : opcoes.modulo10_juntadaMidia;
		opcoes.modoLGPD = typeof(opcoes.modoLGPD) == "undefined" ? false : opcoes.modoLGPD;
		opcoes.modoNoite = typeof(opcoes.modoNoite) == "undefined" ? false : opcoes.modoNoite;
		opcoes.menu_kaizen = typeof(opcoes.menu_kaizen) == "undefined" ? {principal:{posx:'96%',posy:'92%'},detalhes:{posx:'96%',posy:'92%'},tarefas:{posx:'96%',posy:'92%'},sisbajud:{posx:'93%',posy:'80%'},serasajud:{posx:'93%',posy:'80%'},renajud:{posx:'93%',posy:'80%'},cnib:{posx:'93%',posy:'80%'},ccs:{posx:'93%',posy:'80%'},prevjud:{posx:'93%',posy:'80%'},protestojud:{posx:'93%',posy:'80%'},sniper:{posx:'93%',posy:'80%'},censec:{posx:'93%',posy:'80%'},celesc:{posx:'93%',posy:'80%'},casan:{posx:'93%',posy:'80%'},sigef:{posx:'93%',posy:'80%'},saj:{posx:'93%',posy:'80%'}} : opcoes.menu_kaizen;	
		opcoes.menu_kaizen.principal = typeof(opcoes.menu_kaizen.principal) == "undefined" ? {posx:'96%',posy:'92%'} : opcoes.menu_kaizen.principal;
		opcoes.menu_kaizen.detalhes = typeof(opcoes.menu_kaizen.detalhes) == "undefined" ? {posx:'96%',posy:'92%'} : opcoes.menu_kaizen.detalhes;
		opcoes.menu_kaizen.tarefas = typeof(opcoes.menu_kaizen.tarefas) == "undefined" ? {posx:'96%',posy:'92%'} : opcoes.menu_kaizen.tarefas;
		opcoes.menu_kaizen.sisbajud = typeof(opcoes.menu_kaizen.sisbajud) == "undefined" ? {posx:'93%',posy:'80%'} : opcoes.menu_kaizen.sisbajud;
		opcoes.menu_kaizen.serasajud = typeof(opcoes.menu_kaizen.serasajud) == "undefined" ? {posx:'93%',posy:'80%'} : opcoes.menu_kaizen.serasajud;
		opcoes.menu_kaizen.renajud = typeof(opcoes.menu_kaizen.renajud) == "undefined" ? {posx:'93%',posy:'80%'} : opcoes.menu_kaizen.renajud;
		opcoes.menu_kaizen.cnib = typeof(opcoes.menu_kaizen.cnib) == "undefined" ? {posx:'93%',posy:'80%'} : opcoes.menu_kaizen.cnib;
		opcoes.menu_kaizen.ccs = typeof(opcoes.menu_kaizen.ccs) == "undefined" ? {posx:'93%',posy:'80%'} : opcoes.menu_kaizen.ccs;
		opcoes.menu_kaizen.prevjud = typeof(opcoes.menu_kaizen.prevjud) == "undefined" ? {posx:'93%',posy:'80%'} : opcoes.menu_kaizen.prevjud;
		opcoes.menu_kaizen.protestojud = typeof(opcoes.menu_kaizen.protestojud) == "undefined" ? {posx:'93%',posy:'80%'} : opcoes.menu_kaizen.protestojud;
		opcoes.menu_kaizen.sniper = typeof(opcoes.menu_kaizen.sniper) == "undefined" ? {posx:'93%',posy:'80%'} : opcoes.menu_kaizen.sniper;
		opcoes.menu_kaizen.censec = typeof(opcoes.menu_kaizen.censec) == "undefined" ? {posx:'93%',posy:'80%'} : opcoes.menu_kaizen.censec;
		opcoes.menu_kaizen.celesc = typeof(opcoes.menu_kaizen.celesc) == "undefined" ? {posx:'93%',posy:'80%'} : opcoes.menu_kaizen.celesc;
		opcoes.menu_kaizen.casan = typeof(opcoes.menu_kaizen.casan) == "undefined" ? {posx:'93%',posy:'80%'} : opcoes.menu_kaizen.casan;
		opcoes.menu_kaizen.sigef = typeof(opcoes.menu_kaizen.sigef) == "undefined" ? {posx:'93%',posy:'80%'} : opcoes.menu_kaizen.sigef;
		opcoes.menu_kaizen.infoseg = typeof(opcoes.menu_kaizen.infoseg) == "undefined" ? {posx:'93%',posy:'80%'} : opcoes.menu_kaizen.infoseg;
		opcoes.menu_kaizen.ajjt = typeof(opcoes.menu_kaizen.ajjt) == "undefined" ? {posx:'93%',posy:'80%'} : opcoes.menu_kaizen.ajjt;
		opcoes.menu_kaizen.saj = typeof(opcoes.menu_kaizen.saj) == "undefined" ? {posx:'93%',posy:'80%'} : opcoes.menu_kaizen.saj;
		opcoes.modulo9 = typeof(opcoes.modulo9) == "undefined" ? {sisbajud:true,renajud:true,cnib:true,serasajud:true,ccs:[true,false,false,false,false,5],crcjud:true,onr:false,gprec:true,ajjt:true,siscondj:[true,10],garimpo:true,sif:[true,10],pjecalc:true,prevjud:true,protestojud:true,sniper:true,censec:true,celesc:true,casan:true,sigef:true,infoseg:true,ecarta:true,saj:true} : opcoes.modulo9;
		opcoes.modulo9.ccs = Array.isArray(opcoes.modulo9.ccs) ? opcoes.modulo9.ccs : [opcoes.modulo9.ccs,false,false,false,false,5,'Nenhum'];
		opcoes.modulo9.ccs[6] = (opcoes.modulo9.ccs[6] ? opcoes.modulo9.ccs[6] : 'Nenhum');
		opcoes.modulo9.sif = (opcoes.modulo9.sif[1] ? opcoes.modulo9.sif : [true,10]);
		opcoes.modulo9.siscondj = (opcoes.modulo9.siscondj[1] ? opcoes.modulo9.siscondj : [true,10]);
		opcoes.modulo9.gprec = (opcoes.modulo9.gprec[1] ? opcoes.modulo9.gprec : [true,5]);
		if (!Array.isArray(opcoes.modulo9.ecarta)) { opcoes.modulo9.ecarta = [opcoes.modulo9.ecarta,''] }
		opcoes.acionarKaizenComClique = typeof(opcoes.acionarKaizenComClique) == "undefined" ? false : opcoes.acionarKaizenComClique;
		opcoes.kaizenNaHorizontal = typeof(opcoes.kaizenNaHorizontal) == "undefined" ? false : opcoes.kaizenNaHorizontal;
		...
		if (parseInt(opcoes.maisPje_velocidade_interacao) > 2.5) {
			...
			opcoes.maisPje_velocidade_interacao = 1;
		}
		
		if (!opcoes.desativarAjusteJanelas) {
			console.log("...analisando monitores");
			console.log("      |___________" + opcoes.lista_monitores.length);
			if (opcoes.lista_monitores.length == 0) { //somente verifica monitores automaticamente se a opção de ajuste estiver desmarcada e a lista de monitores estiver zerada
		...
		async function inserirFaseModulo2() {
			return new Promise(resolve2 => {
				let lista = [];
				for (const [pos, item] of opcoes.modulo2.entries()) {
		...
		if (typeof(opcoes.modulo9.ecarta) == "undefined") {
			opcoes.modulo9.ecarta[0] = true;
			opcoes.modulo9.ecarta[1] = '';
			await guardarModulo9();
		}
		if (typeof(opcoes.modulo9.saj) == "undefined") { 
...
async function mostrarOpcoes(restaurar=false) {
	return new Promise(async resolve => {
		...
		document.querySelector('#desativarAjusteJanelas').checked = opcoes.desativarAjusteJanelas;
		document.querySelector('#desativarAjusteJanelas').addEventListener('click', function () {
			opcoes.desativarAjusteJanelas = document.querySelector('#desativarAjusteJanelas').checked;
			let var1 = browser.storage.local.set({'desativarAjusteJanelas': opcoes.desativarAjusteJanelas});
		...
		montarNovidades(opcoes.videoAtualizacao, novidades);	
		...
		document.getElementById("modulo4PaginaInicial").value = opcoes.modulo4PaginaInicial != null ? opcoes.modulo4PaginaInicial : "nenhum";
		document.getElementById("modulo4PaginaInicial").addEventListener('focusout', salvarOpcoes);
		document.getElementById("atalhosPlugin").value = desmontarLinha(opcoes.atalhosPlugin, "|");
		
		let contador = 0;
		monitores = opcoes.lista_monitores;
		for(let monitor of monitores) {
			criarOpcaoMonitor(divMonitorDetalhes, monitor, contador, opcoes.gigsMonitorDetalhes, 'gigsMonitorDetalhes');
			criarOpcaoMonitor(divMonitorTarefas, monitor, contador, opcoes.gigsMonitorTarefas, 'gigsMonitorTarefas');
			criarOpcaoMonitor(divMonitorGigs, monitor, contador, opcoes.gigsMonitorGigs, 'gigsMonitorGigs');
			contador = contador + 1;
		}
		
		if (document.querySelector('input[id="gigsMonitorDetalhes' + opcoes.gigsMonitorDetalhes + '"]')) {
			document.querySelector('input[id="gigsMonitorDetalhes' + opcoes.gigsMonitorDetalhes + '"]').checked = true;
		}
		
		if (document.querySelector('input[id="gigsMonitorTarefas' + opcoes.gigsMonitorTarefas + '"]')) {
			document.querySelector('input[id="gigsMonitorTarefas' + opcoes.gigsMonitorTarefas + '"]').checked = true;
		}
		if (document.querySelector('input[id="gigsMonitorGigs' + opcoes.gigsMonitorGigs + '"]')) {
			document.querySelector('input[id="gigsMonitorGigs' + opcoes.gigsMonitorGigs + '"]').checked = true;
		}
		...
		if (typeof(opcoes.meuFiltro) != "undefined") {
			...
			document.querySelector('#meuFiltroJS').checked = opcoes.meuFiltro[11]		
		...
		if (typeof(opcoes.filtros_Favoritos) != "undefined") {
			montarFiltrosFavoritos(document.getElementById('filtros_favoristos_relatorio_GIGS'));
		}
		
		if (typeof(opcoes.emailAutomatizado) == "undefined" || opcoes.emailAutomatizado == null) {
			let titulo = "Processo n. #{processo} (#{tipoDocumento} Id. #{idDocumento})";
			let corpo = "Encaminho o(a) #{tipoDocumento} (Id. #{idDocumento}), expedido no processo #{processo}, para ciência ou cumprimento.\n\nO documento poderá ser acessado via internet mediante o seguinte link: #{autenticacao}\n\nAtenciosamente,";
			let assinatura = "#{servidor}\nDiretor de Secretaria\n#{OJServidor}";
			emailAutomatizado_temp = new EmailAutomatizado(titulo, corpo, assinatura);
		} else {
			emailAutomatizado_temp = opcoes.emailAutomatizado;
		}
		
		document.getElementById("titulo_email").value = emailAutomatizado_temp.titulo;
		document.getElementById("corpo_email").value = emailAutomatizado_temp.corpo;
		document.getElementById("assinatura_email").value = emailAutomatizado_temp.assinatura;
		...
		listaModulo2_temp = opcoes.modulo2;
		if (opcoes.tarefaResponsavel != "" || opcoes.prazoResponsavel != "" || opcoes.atividadeResponsavel != "") {
		...
		listaModulo8_temp = opcoes.modulo8;
		if (listaModulo8_temp.length > 0) {
			listaModulo8_temp = await converter_lista_de_magistrados_em_modulo8();
		}
		montar_modulo8();
		
		document.getElementById("modulo8_criarRegra").addEventListener('click', filtro_Magistrado);
		document.getElementById("convenio_sisbajud").style.backgroundColor = (opcoes.modulo9.sisbajud) ? '#2196F3' : '#b0b0b0';
		document.getElementById("convenio_sisbajud").addEventListener('click', function(event) {modulo9('sisbajud')});
		document.getElementById("convenio_renajud").style.backgroundColor = (opcoes.modulo9.renajud) ? '#2196F3' : '#b0b0b0';
		document.getElementById("convenio_renajud").addEventListener('click', function(event) {modulo9('renajud')});
		document.getElementById("convenio_cnib").style.backgroundColor = (opcoes.modulo9.cnib) ? '#2196F3' : '#b0b0b0';
		document.getElementById("convenio_cnib").addEventListener('click', function(event) {modulo9('cnib')});
		document.getElementById("convenio_serasajud").style.backgroundColor = (opcoes.modulo9.serasajud) ? '#2196F3' : '#b0b0b0';
		document.getElementById("convenio_serasajud").addEventListener('click', function(event) {modulo9('serasajud')});
		document.getElementById("convenio_ccs").style.backgroundColor = (opcoes.modulo9.ccs) ? '#2196F3' : '#b0b0b0';
		document.getElementById("convenio_ccs").addEventListener('click', function(event) {modulo9('ccs')});
		document.getElementById("convenio_crcjud").style.backgroundColor = (opcoes.modulo9.crcjud) ? '#2196F3' : '#b0b0b0';
		document.getElementById("convenio_crcjud").addEventListener('click', function(event) {modulo9('crcjud')});
		document.getElementById("convenio_onr").style.backgroundColor = (opcoes.modulo9.onr) ? '#2196F3' : '#b0b0b0';
		document.getElementById("convenio_onr").addEventListener('click', function(event) {modulo9('onr')});
		document.getElementById("convenio_gprec").style.backgroundColor = (opcoes.modulo9.gprec) ? '#2196F3' : '#b0b0b0';
		document.getElementById("convenio_gprec").addEventListener('click', function(event) {modulo9('gprec')});
		document.getElementById("convenio_ajjt").style.backgroundColor = (opcoes.modulo9.ajjt) ? '#2196F3' : '#b0b0b0';
		document.getElementById("convenio_ajjt").addEventListener('click', function(event) {modulo9('ajjt')});
		document.getElementById("convenio_siscondj").style.backgroundColor = (opcoes.modulo9.siscondj) ? '#2196F3' : '#b0b0b0';
		document.getElementById("convenio_siscondj").addEventListener('click', function(event) {modulo9('siscondj')});
		document.getElementById("convenio_garimpo").style.backgroundColor = (opcoes.modulo9.garimpo) ? '#2196F3' : '#b0b0b0';
		document.getElementById("convenio_garimpo").addEventListener('click', function(event) {modulo9('garimpo')});
		document.getElementById("convenio_sif").style.backgroundColor = (opcoes.modulo9.sif) ? '#2196F3' : '#b0b0b0';
		document.getElementById("convenio_sif").addEventListener('click', function(event) {modulo9('sif')});
		document.getElementById("convenio_pjecalc").style.backgroundColor = (opcoes.modulo9.pjecalc) ? '#2196F3' : '#b0b0b0';
		document.getElementById("convenio_pjecalc").addEventListener('click', function(event) {modulo9('pjecalc')});
		document.getElementById("convenio_prevjud").style.backgroundColor = (opcoes.modulo9.prevjud) ? '#2196F3' : '#b0b0b0';
		document.getElementById("convenio_prevjud").addEventListener('click', function(event) {modulo9('prevjud')});
		document.getElementById("convenio_protestojud").style.backgroundColor = (opcoes.modulo9.protestojud) ? '#2196F3' : '#b0b0b0';
		document.getElementById("convenio_protestojud").addEventListener('click', function(event) {modulo9('protestojud')});
		document.getElementById("convenio_sniper").style.backgroundColor = (opcoes.modulo9.sniper) ? '#2196F3' : '#b0b0b0';
		document.getElementById("convenio_sniper").addEventListener('click', function(event) {modulo9('sniper')});
		document.getElementById("convenio_censec").style.backgroundColor = (opcoes.modulo9.censec) ? '#2196F3' : '#b0b0b0';
		document.getElementById("convenio_censec").addEventListener('click', function(event) {modulo9('censec')});
		document.getElementById("convenio_celesc").style.backgroundColor = (opcoes.modulo9.celesc) ? '#2196F3' : '#b0b0b0';
		document.getElementById("convenio_celesc").addEventListener('click', function(event) {modulo9('celesc')});
		document.getElementById("convenio_casan").style.backgroundColor = (opcoes.modulo9.casan) ? '#2196F3' : '#b0b0b0';
		document.getElementById("convenio_casan").addEventListener('click', function(event) {modulo9('casan')});
		document.getElementById("convenio_sigef").style.backgroundColor = (opcoes.modulo9.sigef) ? '#2196F3' : '#b0b0b0';
		document.getElementById("convenio_sigef").addEventListener('click', function(event) {modulo9('sigef')});
		document.getElementById("convenio_infoseg").style.backgroundColor = (opcoes.modulo9.infoseg) ? '#2196F3' : '#b0b0b0';
		document.getElementById("convenio_infoseg").addEventListener('click', function(event) {modulo9('infoseg')});
		document.getElementById("convenio_ecarta").style.backgroundColor = (opcoes.modulo9.ecarta) ? '#2196F3' : '#b0b0b0';
		document.getElementById("convenio_ecarta").addEventListener('click', function(event) {modulo9('ecarta')});
		document.getElementById("convenio_saj").style.backgroundColor = (opcoes.modulo9.ecarta) ? '#2196F3' : '#b0b0b0';
		document.getElementById("convenio_saj").addEventListener('click', function(event) {modulo9('saj')});
		

		listaModulo10_temp = opcoes.modulo10;
		await montar_modulo10();
		
		//modulo10_juntadaMidia
		if (opcoes.modulo10_juntadaMidia[0]) {
			document.querySelector('#modulo10_juntadaMidia').checked = true;
			document.getElementById("modulo10_juntadaMidia").innerText = opcoes.modulo10_juntadaMidia[1] != "" ? 'Ativar Ação Automatizada para anexar depoimentos : ' + opcoes.modulo10_juntadaMidia[1] : "Ativar Ação Automatizada para anexar depoimentos";
		}
		document.querySelector('#modulo10_juntadaMidia').addEventListener('click', ativarJuntadaDeMidia);
		
		document.querySelector('#acionarKaizenComClique').checked = opcoes.acionarKaizenComClique;
		document.querySelector('#acionarKaizenComClique').addEventListener('click', salvarOpcoes);
		
		document.querySelector('#kaizenNaHorizontal').checked = opcoes.kaizenNaHorizontal;
		...
		document.querySelector('#editorOcultarAutotexto').checked = opcoes.extrasEditorOcultarAutotexto;
		document.querySelector('#editorOcultarAutotexto').addEventListener('click', salvarOpcoes);
		document.querySelector('#editorInverterOrdem').checked = opcoes.extrasEditorInverterOrdem;
		document.querySelector('#editorInverterOrdem').addEventListener('click', salvarOpcoes);
		document.querySelector('#fecharJanelaExpediente').checked = opcoes.extrasFecharJanelaExpediente;
		document.querySelector('#fecharJanelaExpediente').addEventListener('click', salvarOpcoes);
		document.querySelector('#extrasSugerirDescricaoAoAnexar').checked = opcoes.extrasSugerirDescricaoAoAnexar;
		...
		document.querySelector('#ProcurarExecucaoSAO').addEventListener('click', function() {
			...
			if (document.querySelector('#ProcurarExecucaoSAO').checked) {
				opcoes.extrasProcurarExecucao = 'SAO';
		...
		document.querySelector('#ProcurarExecucaoLocal').checked = (opcoes.extrasProcurarExecucao.includes('Local')) ? true : false;
		document.querySelector('#ProcurarExecucaoLocal').addEventListener('click', function() {
			...
			if (document.querySelector('#ProcurarExecucaoLocal').checked) {
				opcoes.extrasProcurarExecucao = 'Local';
...
async function salvarOpcoes() {
	return new Promise(async resolve => {
		...
		await browser.storage.local.set({
			...
			aaLancarMovimentos : opcoes.aaLancarMovimentos,
			aaVariados : aaVariados_temp,
			atalhosPlugin : montarAtalhosPlugin(),
			emailAutomatizado : emailAutomatizado_temp,
			videoAtualizacao: true,
			modulo8: listaModulo8_temp,
			modulo9: opcoes.modulo9,
			modulo2: listaModulo2_temp,
			sisbajud: opcoes.sisbajud,
			renajud: opcoes.renajud,
			serasajud: opcoes.serasajud,
			modulo10: listaModulo10_temp,
			lista_monitores: monitores,
			modoLGPD: opcoes.modoLGPD,
			modoNoite: opcoes.modoNoite,
			menu_kaizen: opcoes.menu_kaizen,
			...
			extrasEditorOcultarAutotexto: document.querySelector('#editorOcultarAutotexto').checked,
			extrasEditorInverterOrdem: document.querySelector('#editorInverterOrdem').checked,
...
async function zerarPosicoesKaizen() {
	opcoes.menu_kaizen = {principal:{posx:'96%',posy:'92%'},detalhes:{posx:'96%',posy:'92%'},tarefas:{posx:'96%',posy:'92%'},sisbajud:{posx:'93%',posy:'80%'},serasajud:{posx:'93%',posy:'80%'},renajud:{posx:'93%',posy:'80%'},cnib:{posx:'93%',posy:'80%'},ccs:{posx:'93%',posy:'80%'}};
	salvarOpcoes();
}
...
function ajustarAAVariados() {
	return new Promise(resolve => {
		...
		opcoes.aaVariados = aaVariados_temp;
		aaVariados_temp = opcoes.aaVariados;
		resolve(aaVariados_temp);
	});
}
...
async function converter_lista_de_atividades_em_modulo2() {
	...
	if (opcoes.tarefaResponsavel) {
		opcoes.atividadeResponsavel.concat(opcoes.tarefaResponsavel);
	}
	
	//GIGS PRAZOS - versão 2.6.5
	if (opcoes.prazoResponsavel) {
		opcoes.atividadeResponsavel.concat(opcoes.prazoResponsavel);;
	}
	
	//GIGS ATIVIDADES - versão 2.7.0
	if (opcoes.atividadeResponsavel) {
		lista_temp = opcoes.atividadeResponsavel.split('|');
	}
...
async function filtro_Atividades() {
	...
	if (result) {
		...
		opcoes.modulo2 = listaModulo2_temp;
		montar_modulo2();
		salvarOpcoes();
	}
}
...
async function filtro_Magistrado() {
	const { value: result } = await Swal.fire({
		...
		html:
			...
			'<label class="container">' +
			'<input type="checkbox" id="modulo8_Filtro0"><span style="position: relative; padding-right: 15px; top: 2px; margin-left: -10px; font-size: 24px;">0</span>' +
			'<span class="checkmark"></span>' +
			'</label>' + 
			'<label class="container">' + 
			...
			'<select id="modulo8_orgaoJulgadorCargo" class="swal2-select" style="background-color: white;width: 100%; border: 1px solid #d9d9d9;border-radius: .1875em;box-shadow: inset 0 1px 1px rgba(0,0,0,.06);height: 2.625em;padding: 0 .75em;">' + 
				...
				'<option value="Juiz Titular"> Juiz Titular </option>' + 
		...
		preConfirm: () => {
			let resposta = "";
			resposta += document.getElementById('modulo8_Filtro0').checked;
			resposta += "|";
...
async function editar_filtro_Magistrado(pos) {
	...
	const { value: result } = await Swal.fire({
		...
		html:
			...
			'<div id="escolherProcessoFinal" class="destacarToogle" style="padding: 10px;border-radius: .1875em;">' +
			'<label class="container">' +
			'<input type="checkbox" id="modulo8_Filtro0" ' + (item[0] === 'true' ? 'checked' : '') + '><span style="position: relative; padding-right: 15px; top: 2px; margin-left: -10px; font-size: 24px;">0</span>' +
			'<span class="checkmark"></span>' +
			'</label>' + 
			'<label class="container">' + 
			...
			'<select id="modulo8_orgaoJulgadorCargo" class="swal2-select" style="background-color: white;width: 100%;border: 1px solid #d9d9d9; border-radius: .1875em;box-shadow: inset 0 1px 1px rgba(0,0,0,.06);height: 2.625em;padding: 0 .75em;">' + 
				'<option value="TODOS"> TODOS </option>' + 
				'<option value="Juiz Titular"' + (item[12].toLowerCase().includes('titular') ? 'selected' : '')  + '> Juiz Titular </option>' + 
				'<option value="Juiz Substituto"' + (item[12].toLowerCase().includes('substituto') ? 'selected' : '')  + '> Juiz Substituto </option>' + 
			'</select>' +
			'</div></div>',
		showCancelButton: true,
		focusConfirm: false,
...
async function modulo9(convenio) {
	switch (convenio) {			
		case 'sisbajud':
			...
			let teimosinha = (!opcoes.sisbajud.teimosinha) ? 'nao' : opcoes.sisbajud.teimosinha;
			...
			let agenciaDisabled = opcoes.sisbajud.banco_preferido.includes('[') ? true : false;
			...
			let { value: resultsisbajud } = await Swal.fire({
				...
				html:
					...
					'<input type="checkbox" id="swal2-checkbox"' + (opcoes.modulo9.sisbajud ? ' checked ' : '') + '>' +
					'<span class="swal2-label"> Ativar</span><div style="display: grid;grid-template-columns: 1fr 1fr;align-items: center;">' +
					...
					'<span style="font-weight: bold;"> Juiz solicitante da Ordem: </span>' + 
					'<input id="swal-input1" class="swal2-input"" value="' + opcoes.sisbajud.juiz + '" style="margin-bottom: 0;">' +
					'<span style="font-weight: bold;"> </span>' + 
					'<span style="font-weight: normal;font-size: 0.8em;color: cadetblue;"> Para usar a regra do Módulo 8 digite: MODULO8 </span>' + 
					'<span style="font-weight: bold;"> Vara/Juízo da ordem (use o código): </span>' + 
					'<input id="swal-input2" class="swal2-input"" value="' + opcoes.sisbajud.vara + '">' +
					...
					'<span style="font-weight: bold;"> Bloqueio sobre o CNPJ Raiz? </span>' +			
					'<select id="swal-input3" class="swal2-select" style="background-color: white;width: 100%;border: 1px solid #d9d9d9;border-radius: .1875em;box-shadow: inset 0 1px 1px rgba(0,0,0,.06);height: 2.625em;padding: 0 .75em;">' + 
						'<option value="nao"' + (opcoes.sisbajud.cnpjRaiz.toLowerCase().includes('nao') ? 'selected' : '')  + '> Não </option>' + 
						'<option value="sim"' + (opcoes.sisbajud.cnpjRaiz.toLowerCase().includes('sim') ? 'selected' : '')  + '> Sim </option>' + 
					'</select>' +
					
					'<span style="font-weight: bold;"> Teimosinha? </span>' +			
					...
					'<span style="font-weight: bold;"> Penhorar conta-salário? </span>' +			
					'<select id="swal-input5" class="swal2-select" style="background-color: white;width: 100%;border: 1px solid #d9d9d9;border-radius: .1875em;box-shadow: inset 0 1px 1px rgba(0,0,0,.06);height: 2.625em;padding: 0 .75em;">' + 
						'<option value="nao"' + (opcoes.sisbajud.contasalario.toLowerCase().includes('nao') ? 'selected' : '')  + '> Não </option>' + 
						'<option value="sim"' + (opcoes.sisbajud.contasalario.toLowerCase().includes('sim') ? 'selected' : '')  + '> Sim </option>' + 
					'</select>' +
					
					'<span style="font-weight: bold;"> Preencher o Valor da Execução? </span>' +			
					'<select id="swal-input11" class="swal2-select" style="background-color: white;width: 100%;border: 1px solid #d9d9d9;border-radius: .1875em;box-shadow: inset 0 1px 1px rgba(0,0,0,.06);height: 2.625em;padding: 0 .75em;">' + 
						'<option value="nao"' + (opcoes.sisbajud.preencherValor.toLowerCase().includes('nao') ? 'selected' : '')  + '> Não </option>' + 
						'<option value="sim"' + (opcoes.sisbajud.preencherValor.toLowerCase().includes('sim') ? 'selected' : '')  + '> Sim </option>' + 
					'</select>' +
					
					'<span style="font-weight: bold;"> Clicar em Salvar e Protocolar? </span>' +		
					'<select id="swal-input13" class="swal2-select" style="background-color: white;width: 100%;border: 1px solid #d9d9d9;border-radius: .1875em;box-shadow: inset 0 1px 1px rgba(0,0,0,.06);height: 2.625em;padding: 0 .75em;">' + 
						'<option value="nao"' + (opcoes.sisbajud.salvarEprotocolar.toLowerCase().includes('nao') ? 'selected' : '')  + '> Não </option>' + 
						'<option value="sim"' + (opcoes.sisbajud.salvarEprotocolar.toLowerCase().includes('sim') ? 'selected' : '')  + '> Sim </option>' + 
					'</select>' +
					
					'<span style="font-weight: bold;"> Escolher Ação Automatizada para executar após o protocolo da ordem? </span>' +			
					...
					listaAcoesAutomatizadas(opcoes.sisbajud.executarAAaoFinal) + 
					'</select>' +
					...
					'<span style="font-weight: bold;"> Não-Respostas? Reiterar ou Cancelar: </span>' + 
					'<input id="swal-input6" class="swal2-input"" value="' + opcoes.sisbajud.naorespostas + '">' +
					'<span style="font-weight: bold;"> Desbloquear valores abaixo de: </span>' + 
					'<input id="swal-input7" class="swal2-input"" value="' + opcoes.sisbajud.valor_desbloqueio + '">' +
					'<span style="font-weight: bold;"> Banco preferido (em caso de bloqueio): </span>' + 
					'<input id="swal-input8" class="swal2-input"" value="' + opcoes.sisbajud.banco_preferido + '" style="margin-bottom: 0;">' +
					...
					'<span style="font-weight: bold;"> Agência preferida (em caso de bloqueio): </span>' + 
					'<input id="swal-input9" class="swal2-input" ' + (agenciaDisabled ? 'disabled style="background-color: #d3d3d350;"' : 'value="' + opcoes.sisbajud.agencia_preferida + '"') + '>' +
					'<span style="font-weight: bold;"> Confirmar Banco e Agência? </span>' +			
					'<select id="swal-input10" class="swal2-select" style="background-color: white;width: 100%;border: 1px solid #d9d9d9;border-radius: .1875em;box-shadow: inset 0 1px 1px rgba(0,0,0,.06);height: 2.625em;padding: 0 .75em;">' + 
						'<option value="nao"' + (opcoes.sisbajud.confirmar.toLowerCase().includes('nao') ? 'selected' : '')  + '> Não </option>' + 
						'<option value="sim"' + (opcoes.sisbajud.confirmar.toLowerCase().includes('sim') ? 'selected' : '')  + '> Sim </option>' + 
					'</select>',
			...
			if (resultsisbajud) {
				opcoes.modulo9.sisbajud = resultsisbajud[0];
				await guardarModulo9();
				document.getElementById("convenio_sisbajud").style.backgroundColor = (opcoes.modulo9.sisbajud) ? '#2196F3' : '#b0b0b0';
				...
				let var1_sisbajud = browser.storage.local.set({'sisbajud': opcoes.sisbajud});
		...
		case 'renajud':
			let { value: resultrenajud } = await Swal.fire({
				title: 'RENAJUD',
				html:
					'A extensão traz a varinha mágica para dentro do RENAJUD. Com isso na tela de inclusão de restrições, ao acioná-la, basta escolher os executados para pesquisa e pronto, a extensão faz a consulta de todos pra você. Ela também preenche o número do processo nas telas de consulta e cancelamento para facilitar a busca.<br><br>' +
					'<input type="checkbox" id="swal2-checkbox"' + (opcoes.modulo9.renajud ? ' checked ' : '') + '>' +
					'<span class="swal2-label"> Ativar</span><div style="display: grid;grid-template-columns: 1fr 1fr;align-items: center;">' +
					'<span style="font-weight: bold;"> Tipo de restrição (Transferência, Licenciamento ou Circulação): </span>' + 
					'<input id="swal-input1" class="swal2-input"" value="' + opcoes.renajud.tipo_restricao + '">' +
					'<span style="font-weight: bold;"> Comarca (Renajud Antigo): </span>' + 
					'<input id="swal-input2" class="swal2-input"" value="' + opcoes.renajud.comarca + '">' +
					'<span style="font-weight: bold;"> Tribunal (Renajud Novo): </span>' + 
					'<input id="swal-input3" class="swal2-input"" value="' + opcoes.renajud.tribunal + '">' +
					'<span style="font-weight: bold;"> Órgão: </span>' + 
					'<input id="swal-input4" class="swal2-input"" value="' + opcoes.renajud.orgao + '">' +
					'<span style="font-weight: bold;"> Juiz (Renajud Antigo): </span>' + 
					'<input id="swal-input5" class="swal2-input"" value="' + opcoes.renajud.juiz + '">' +
					'<span style="font-weight: bold;"> Juiz (Renajud Novo): </span>' + 
					'<input id="swal-input6" class="swal2-input"" value="' + opcoes.renajud.juiz2 + '">',
				focusConfirm: false,
				confirmButtonText: 'Salvar',
				width: 800,
				preConfirm: () => {
			...
			if (resultrenajud) {
				opcoes.modulo9.renajud = resultrenajud[0];
				await guardarModulo9();
				document.getElementById("convenio_renajud").style.backgroundColor = (opcoes.modulo9.renajud) ? '#2196F3' : '#b0b0b0';
				...
				let var1_renajud = browser.storage.local.set({'renajud': opcoes.renajud});
		...
		case 'cnib':
			let { value: resultcnib } = await Swal.fire({
				title: 'CNIB',
				html:
					'A extensão traz a varinha mágica para dentro do CNIB. Com isso na tela de inclusão de indisponibilidade, ao acioná-la, basta escolher os executados para pesquisa e pronto, a extensão faz a inclusão de todos pra você. Ela também preenche o número do processo nas telas de consulta e cancelamento para facilitar a busca.<br><br>' +
					'<input type="checkbox" id="swal2-checkbox"' + (opcoes.modulo9.cnib ? ' checked ' : '') + '>' +
			...
			if (resultcnib) {
				opcoes.modulo9.cnib = resultcnib[0];
				await guardarModulo9();
				document.getElementById("convenio_cnib").style.backgroundColor = (opcoes.modulo9.cnib) ? '#2196F3' : '#b0b0b0';
			}
			break
		case 'serasajud':
			let { value: resultserasajud } = await Swal.fire({
				title: 'SERASAJUD',
				html:
					'A extensão traz a varinha mágica para dentro do SERASAJUD. Com isso na tela de cadastro de nova ordem, ao acioná-la, basta escolher os executados para pesquisa e pronto, a extensão faz a inclusão de todos pra você. Você também pode utilizar a varinha mágica na tela de requisição de endereço. Ela também preenche o número do processo nas telas de consulta e cancelamento para facilitar a busca.<br><br>' +
					'<input type="checkbox" id="swal2-checkbox"' + (opcoes.modulo9.serasajud ? ' checked ' : '') + '>' +
					'<span class="swal2-label"> Ativar</span><div style="display: grid;grid-template-columns: 1fr 1fr;align-items: center;">' +
					'<span style="font-weight: bold;"> Juiz solicitante da Ordem: </span>' + 
					'<input id="swal-input1" class="swal2-input"" value="' + opcoes.serasajud.juiz + '">' +
					'<span style="font-weight: bold;"> Foro da ordem: </span>' + 
					'<input id="swal-input2" class="swal2-input"" value="' + opcoes.serasajud.foro + '">' +
					'<span style="font-weight: bold;"> Vara da ordem: </span>' + 
					'<input id="swal-input3" class="swal2-input"" value="' + opcoes.serasajud.vara + '">' +
					'<span style="font-weight: bold;"> Prazo de Atendimento - Preencha apenas o número (5)dias (72)horas (48)horas (24)horas: </span>' + 
					'<input id="swal-input4" class="swal2-input"" value="' + opcoes.serasajud.prazo_atendimento + '">',
				focusConfirm: false,
				confirmButtonText: 'Salvar',
				width: 800,
				preConfirm: () => {
			...
			if (resultserasajud) {
				opcoes.modulo9.serasajud = resultserasajud[0];
				await guardarModulo9();
				document.getElementById("convenio_serasajud").style.backgroundColor = (opcoes.modulo9.serasajud) ? '#2196F3' : '#b0b0b0';
				
				opcoes.serasajud = {
					juiz: resultserasajud[1],
					foro: resultserasajud[2],
					vara: resultserasajud[3],
					prazo_atendimento: resultserasajud[4]
				};
				let var1_serasajud = browser.storage.local.set({'serasajud': opcoes.serasajud});
			...
			break
		case 'ccs':
			let aaCCS = (opcoes.modulo9.ccs[6] ? opcoes.modulo9.ccs[6] : 'Nenhum');
			let { value: resultccs } = await Swal.fire({
				title: 'CCS',
				html:
					'A extensão traz a varinha mágica para dentro do CCS. Com isso na tela de cadastro de nova ordem, ao acioná-la, basta escolher os executados para pesquisa e pronto, a extensão faz a inclusão de todos pra você. Você também pode utilizar a consulta rápida de processo para abrir um processo diretamente no PJe.<br><br>' +
					'<input type="checkbox" id="swal2-checkbox0"' + (opcoes.modulo9.ccs[0] ? ' checked ' : '') + '>' +
					'<span class="swal2-label"> Ativar</span><br><br>' + 
					'<div style="background-color: #95959512;padding: 10px;border-radius: 10px;">' + 
					'<span style="font-weight: bold;"> Prosseguir Automaticamente:</span>' + 
					'<div style="display: grid;grid-template-rows: 1fr 1fr 1fr;grid-gap: 5px;margin-top: 15px;text-align: initial;padding-left: 35%;">' + 
					'<div><input type="checkbox" id="swal2-checkbox1"' + (opcoes.modulo9.ccs[1] ? ' checked ' : '') + '>na tela "Requisitar consulta"</div>' +
					'<div><input type="checkbox" id="swal2-checkbox2"' + (opcoes.modulo9.ccs[2] ? ' checked ' : '') + '>na tela "Confirmar consulta"</div>' +
					'<div><input type="checkbox" id="swal2-checkbox3"' + (opcoes.modulo9.ccs[3] ? ' checked ' : '') + '>na tela "Solicitação de detalhamentos"</div>' +
					'<div><input type="checkbox" id="swal2-checkbox4"' + (opcoes.modulo9.ccs[4] ? ' checked ' : '') + '>na tela "Escolher as contas"</div>' +
					'</div></div><br><br>'+
					'<div style="background-color: #95959512;padding: 10px;border-radius: 10px;"><span style="font-weight: bold;"> Velocidade de Interação no CCS (em segundos)</span>' + 
					'<input id="swal-input1" class="swal2-input" style="background-color: white;" value="' + opcoes.modulo9.ccs[5] + '"></div>' +
					'<div><span style="font-weight: bold;"> Escolher Ação Automatizada para executar após o protocolo da ordem? </span>' +			
		...
		case 'crcjud':
			let { value: resultcrcjud } = await Swal.fire({
				...
				html:
					...
					'<input type="checkbox" id="swal2-checkbox"' + (opcoes.modulo9.crcjud ? ' checked ' : '') + '>' +
					'<span class="swal2-label"> Ativar</span>',
				focusConfirm: false,
				confirmButtonText: 'Salvar',
				width: 800,
			...
			if (resultcrcjud) {
				opcoes.modulo9.crcjud = resultcrcjud[0];
				await guardarModulo9();
				document.getElementById("convenio_crcjud").style.backgroundColor = (opcoes.modulo9.crcjud) ? '#2196F3' : '#b0b0b0';
			}
			break
		case 'onr':
			opcoes.modulo9.onr = false;
			let { value: resultonr } = await Swal.fire({
				...
				html:
					...
					'<input type="checkbox" id="swal2-checkbox"' + (opcoes.modulo9.onr ? ' checked ' : '') + '>' +
					'<span class="swal2-label"> Ativar </span>',
				focusConfirm: false,
				confirmButtonText: 'Salvar',
				width: 800,
			...
			if (resultonr) {
				opcoes.modulo9.onr = resultonr[0];
				await guardarModulo9();
				document.getElementById("convenio_onr").style.backgroundColor = (opcoes.modulo9.onr) ? '#2196F3' : '#b0b0b0';
			}
			break
		case 'gprec':
			let { value: resultgprec } = await Swal.fire({
				...
				html:
					...
					'<input type="checkbox" id="swal2-checkbox"' + (opcoes.modulo9.gprec[0] ? ' checked ' : '') + '>' +
					'<span class="swal2-label"> Ativar</span><br><br>' + 
					'<div style="background-color: #95959512;padding: 10px;border-radius: 10px;"><span style="font-weight: bold;"> Velocidade de Interação no GPREC (em segundos)</span>' + 
					'<input id="swal-input1" class="swal2-input" style="background-color: white;" value="' + opcoes.modulo9.gprec[1] + '"></div>',
				focusConfirm: false,
				confirmButtonText: 'Salvar',
				width: 800,
				preConfirm: () => {
			...
			if (resultgprec) {
				opcoes.modulo9.gprec[0] = resultgprec[0];
				opcoes.modulo9.gprec[1] = resultgprec[1];
				await guardarModulo9();
				document.getElementById("convenio_gprec").style.backgroundColor = (opcoes.modulo9.gprec) ? '#2196F3' : '#b0b0b0';
			}
			break
		case 'ajjt':
			let { value: resultajjt } = await Swal.fire({
				...
				html:
					...
					'<input type="checkbox" id="swal2-checkbox"' + (opcoes.modulo9.ajjt ? ' checked ' : '') + '>' +
					'<span class="swal2-label"> Ativar</span>',
				focusConfirm: false,
				confirmButtonText: 'Salvar',
				width: 800,
			...
			if (resultajjt) {
				opcoes.modulo9.ajjt = resultajjt[0];
				await guardarModulo9();
				document.getElementById("convenio_ajjt").style.backgroundColor = (opcoes.modulo9.ajjt) ? '#2196F3' : '#b0b0b0';
			}
			break			
		case 'siscondj':
			let { value: resultsiscondj } = await Swal.fire({
				...
				html:
					...
					'<input type="checkbox" id="swal2-checkbox"' + (opcoes.modulo9.siscondj[0] ? ' checked ' : '') + '>' +
					'<span class="swal2-label"> Ativar</span><br><br>' + 
					...
					'<input id="swal-input1" class="swal2-input" style="background-color: white;" value="' + opcoes.modulo9.siscondj[1] + '"></div>',
				focusConfirm: false,
				confirmButtonText: 'Salvar',
				width: 800,
				preConfirm: () => {
			...
			if (resultsiscondj) {
				opcoes.modulo9.siscondj[0] = resultsiscondj[0];
				opcoes.modulo9.siscondj[1] = resultsiscondj[1];
				await guardarModulo9();
				document.getElementById("convenio_siscondj").style.backgroundColor = (opcoes.modulo9.siscondj) ? '#2196F3' : '#b0b0b0';
			}
			break			
		case 'garimpo':			
			let { value: resultgarimpo } = await Swal.fire({
				...
				html:
					...
					'<input type="checkbox" id="swal2-checkbox"' + (opcoes.modulo9.garimpo ? ' checked ' : '') + '>' +
					'<span class="swal2-label"> Ativar</span>',
				focusConfirm: false,
				confirmButtonText: 'Salvar',
				width: 800,
			...
			if (resultgarimpo) {
				opcoes.modulo9.garimpo = resultgarimpo[0];
				await guardarModulo9();
				document.getElementById("convenio_garimpo").style.backgroundColor = (opcoes.modulo9.garimpo) ? '#2196F3' : '#b0b0b0';
			}
			break
		case 'sif':
			let { value: resultsif } = await Swal.fire({
				...
				html:
					...
					'<input type="checkbox" id="swal2-checkbox"' + (opcoes.modulo9.sif[0] ? ' checked ' : '') + '>' +
					'<span class="swal2-label"> Ativar</span><br><br>' + 
					'<div style="background-color: #95959512;padding: 10px;border-radius: 10px;"><span style="font-weight: bold;"> Velocidade de Interação no SIF (em segundos)</span>' + 
					'<input id="swal-input1" class="swal2-input" style="background-color: white;" value="' + opcoes.modulo9.sif[1] + '"></div>',
				focusConfirm: false,
				confirmButtonText: 'Salvar',
				width: 800,
				preConfirm: () => {
			...
			if (resultsif) {
				opcoes.modulo9.sif[0] = resultsif[0];
				opcoes.modulo9.sif[1] = resultsif[1];
				await guardarModulo9();
				document.getElementById("convenio_sif").style.backgroundColor = (opcoes.modulo9.sif) ? '#2196F3' : '#b0b0b0';
			}
			break
		case 'pjecalc':
			...
			if (resultpjecalc) {
				opcoes.modulo9.pjecalc = resultpjecalc[0];
				await guardarModulo9();
				document.getElementById("convenio_pjecalc").style.backgroundColor = (opcoes.modulo9.pjecalc) ? '#2196F3' : '#b0b0b0';
			}
			break
		case 'prevjud':
			let { value: resultprevjud } = await Swal.fire({
				title: 'prevjud',
				html:
			'A extensão traz a varinha mágica para dentro do PREVJUD. Com isso na tela de cadastro de nova ordem, ao acioná-la, basta escolher o reclamante. Primeiro será realizado a pesquisa de eventual ordem anterior, e caso não seja encontrado será inserido uma nova ordem.<br><br>' +
					'<input type="checkbox" id="swal2-checkbox"' + (opcoes.modulo9.prevjud ? ' checked ' : '') + '>' +
					'<span class="swal2-label"> Ativar</span>',
				focusConfirm: false,
				confirmButtonText: 'Salvar',
				width: 800,
			...
			if (resultprevjud) {
				opcoes.modulo9.prevjud = resultprevjud[0];
				await guardarModulo9();
				document.getElementById("convenio_prevjud").style.backgroundColor = (opcoes.modulo9.prevjud) ? '#2196F3' : '#b0b0b0';
			}
			break
		case 'protestojud':
			let { value: resultprotestojud } = await Swal.fire({
				...
				html:
					...
					'<input type="checkbox" id="swal2-checkbox"' + (opcoes.modulo9.protestojud ? ' checked ' : '') + '>' +
					'<span class="swal2-label"> Ativar</span>',
				focusConfirm: false,
				confirmButtonText: 'Salvar',
				width: 800,
			...
			if (resultprotestojud) {
				opcoes.modulo9.protestojud = resultprotestojud[0];
				await guardarModulo9();
				document.getElementById("convenio_protestojud").style.backgroundColor = (opcoes.modulo9.protestojud) ? '#2196F3' : '#b0b0b0';
			}
			break
		case 'sniper':
			let { value: resultsniper } = await Swal.fire({
				title: 'SNIPER',
				html:
			'A extensão traz a varinha mágica para dentro do SNIPER permitindo a consulta do Executado escolhido. Deve ser escolhido um executado por vez. A extensão também traz o Assistente de impressão.<br><br>' +
					'<input type="checkbox" id="swal2-checkbox"' + (opcoes.modulo9.protestojud ? ' checked ' : '') + '>' +
					'<span class="swal2-label"> Ativar</span>',
				focusConfirm: false,
				confirmButtonText: 'Salvar',
			...
			if (resultsniper) {
				opcoes.modulo9.sniper = resultsniper[0];
				await guardarModulo9();
				document.getElementById("convenio_sniper").style.backgroundColor = (opcoes.modulo9.sniper) ? '#2196F3' : '#b0b0b0';
			}
			break
		case 'censec':
			let { value: resultcensec } = await Swal.fire({
				title: 'CENSEC',
				html:
			'A extensão traz a varinha mágica para dentro do CENSEC permitindo a consulta do Executado escolhido. Deve ser escolhido um executado por vez. A extensão também traz o Assistente de impressão.<br><br>' +
					'<input type="checkbox" id="swal2-checkbox"' + (opcoes.modulo9.censec ? ' checked ' : '') + '>' +
					'<span class="swal2-label"> Ativar</span>',
				focusConfirm: false,
				confirmButtonText: 'Salvar',
				width: 800,
			...
			if (resultcensec) {
				opcoes.modulo9.censec = resultcensec[0];
				await guardarModulo9();
				document.getElementById("convenio_censec").style.backgroundColor = (opcoes.modulo9.censec) ? '#2196F3' : '#b0b0b0';
			}
			break
		case 'celesc':
			let { value: resultcelesc } = await Swal.fire({
				...
				html:
			'A extensão traz a varinha mágica para dentro do convênio CELESC permitindo a consulta do Executado escolhido. Deve ser escolhido um executado por vez. A extensão também traz o Assistente de impressão. CONVÊNIO EXCLUSIVO do TRT12.<br><br>' +
					'<input type="checkbox" id="swal2-checkbox"' + (opcoes.modulo9.celesc ? ' checked ' : '') + '>' +
					'<span class="swal2-label"> Ativar</span>',
				focusConfirm: false,
				confirmButtonText: 'Salvar',
				width: 800,
			...
			if (resultcelesc) {
				opcoes.modulo9.celesc = resultcelesc[0];
				await guardarModulo9();
				document.getElementById("convenio_celesc").style.backgroundColor = (opcoes.modulo9.celesc) ? '#2196F3' : '#b0b0b0';
			}
			break
		case 'casan':
			let { value: resultcasan } = await Swal.fire({
				...
				html:
			'A extensão traz a varinha mágica para dentro do convênio CASAN permitindo a consulta do Executado escolhido. Deve ser escolhido um executado por vez. A extensão também traz o Assistente de impressão. CONVÊNIO EXCLUSIVO do TRT12.<br><br>' +
					'<input type="checkbox" id="swal2-checkbox"' + (opcoes.modulo9.casan ? ' checked ' : '') + '>' +
					'<span class="swal2-label"> Ativar</span>',
				focusConfirm: false,
				confirmButtonText: 'Salvar',
				width: 800,
			...
			if (resultcasan) {
				opcoes.modulo9.casan = resultcasan[0];
				await guardarModulo9();
				document.getElementById("convenio_casan").style.backgroundColor = (opcoes.modulo9.casan) ? '#2196F3' : '#b0b0b0';
			}
			break
		case 'sigef':
			let { value: resultsigef } = await Swal.fire({
				title: 'SIGEF',
				html:
			'A extensão traz a varinha mágica para dentro do convênio SIGEF (INCRA) permitindo a consulta do Executado escolhido. Deve ser escolhido um executado por vez. A extensão também traz o Assistente de impressão.<br><br>' +
					'<input type="checkbox" id="swal2-checkbox"' + (opcoes.modulo9.sigef ? ' checked ' : '') + '>' +
					'<span class="swal2-label"> Ativar</span>',
				focusConfirm: false,
				confirmButtonText: 'Salvar',
				width: 800,
			...
			if (resultsigef) {
				opcoes.modulo9.sigef = resultsigef[0];
				await guardarModulo9();
				document.getElementById("convenio_sigef").style.backgroundColor = (opcoes.modulo9.sigef) ? '#2196F3' : '#b0b0b0';
			}
			break
		case 'infoseg':
			let { value: resultinfoseg } = await Swal.fire({
				title: 'INFOSEG',
				html:
			'A extensão traz a varinha mágica para dentro do convênio INFOSEG permitindo a consulta do Executado escolhido. Deve ser escolhido um executado por vez.<br><br>' +
					'<input type="checkbox" id="swal2-checkbox"' + (opcoes.modulo9.infoseg ? ' checked ' : '') + '>' +
					'<span class="swal2-label"> Ativar</span>',
				focusConfirm: false,
				confirmButtonText: 'Salvar',
				width: 800,
			...
			if (resultinfoseg) {
				opcoes.modulo9.infoseg = resultinfoseg[0];
				await guardarModulo9();
				document.getElementById("convenio_infoseg").style.backgroundColor = (opcoes.modulo9.infoseg) ? '#2196F3' : '#b0b0b0';
			}
			break
		case 'ecarta':
			let { value: resultecarta } = await Swal.fire({
				...
				html:
					...
					'<input type="checkbox" id="swal2-checkbox"' + (opcoes.modulo9.ecarta[0] ? ' checked ' : '') + '>' +
					'<span class="swal2-label"> Ativar</span>' + 
					'<div style="background-color: #95959512;padding: 10px;border-radius: 10px;"><span style="font-weight: bold;"> Endereço para consulta de AR </span>' + 
					'<input id="swal-input1" class="swal2-input" style="background-color: white;" value="' + opcoes.modulo9.ecarta[1] + '"></div>' +
			...
			if (resultecarta) {
				opcoes.modulo9.ecarta[0] = resultecarta[0];
				opcoes.modulo9.ecarta[1] = resultecarta[1];
				await guardarModulo9();
				document.getElementById("convenio_ecarta").style.backgroundColor = (opcoes.modulo9.ecarta) ? '#2196F3' : '#b0b0b0';
			}
			break
		case 'saj':
			let { value: resultsaj } = await Swal.fire({
				...
				html:
				'A extensão traz a varinha mágica para dentro do SAJ (AFASTAMENTO DE SIGILO BANCÁRIO). Com isso na tela de cadastro de nova ordem, ao acioná-la, basta escolher os executados para pesquisa e pronto, a extensão faz a inclusão de todos pra você.Ela também preenche o número do processo nas telas de consulta e cancelamento para facilitar a busca.<br><br>' +
				'<input type="checkbox" id="swal2-checkbox"' + (opcoes.modulo9.saj ? ' checked ' : '') + '>' +
				'<span class="swal2-label"> Ativar</span><div style="display: grid;grid-template-columns: 1fr 1fr;align-items: center;">' +
				'<span style="font-weight: bold;"> Vara da ordem: </span>' + 
				'<input id="swal-input1" class="swal2-input"" value="' + opcoes.saj.vara + '">' +
				'<span style="font-weight: bold;"> Juiz solicitante da Ordem: </span>' + 
				'<input id="swal-input2" class="swal2-input"" value="' + opcoes.saj.juiz + '" style="margin-bottom: 0;">' +
				'<span style="font-weight: bold;"> </span>' + 
				'<span style="font-weight: normal;font-size: 0.8em;color: cadetblue;"> Para usar a regra do Módulo 8 digite: MODULO8 </span>' + 
				'<span style="font-weight: bold;"> Prazo da resposta: </span>' + 
				'<input id="swal-input3" class="swal2-input"" value="' + opcoes.saj.prazoResposta + '">' +
				'<span style="font-weight: bold;"> Informações Solicitadas </span>' + 
				'<span style="font-weight: bold;"> </span>' + 
				'<span class="swal2-label" style="text-align: right; padding: 20px 0 10px 0;"> Extrato Mercantil </span>' +
				'<span style="text-align: left; padding: 20px 0 10px 0;"><input type="checkbox" id="swal2-extratomercantil"' + (opcoes.saj.extratomercantil ? ' checked ' : '') + ' style="cursor: pointer;height: 25px;width: 25px;"></span>' +
				'<span class="swal2-label" style=" padding: 10px 0;text-align: right;"> Extrato de movimentação - Carta-Circular 3454 (Simba)</span>' +
				'<span style="text-align: left; padding: 10px 0;"><input type="checkbox" id="swal2-extratomovimentacao"' + (opcoes.saj.extratomovimentacao ? ' checked ' : '') + ' style="cursor: pointer;height: 25px;width: 25px;"></span>' +
				'<span class="swal2-label" style=" padding: 10px 0;text-align: right;"> Extrato de aplicações financeiras</span>' +
				'<span style="text-align: left; padding: 10px 0;"><input type="checkbox" id="swal2-extratomovfinanceira"' + (opcoes.saj.extratomovfinanceira ? ' checked ' : '') + ' style="cursor: pointer;height: 25px;width: 25px;"></span>' +
				'<span class="swal2-label" style=" padding: 10px 0;text-align: right;"> Fatura de cartão de crédito</span>' +
				'<span style="text-align: left; padding: 10px 0;"><input type="checkbox" id="swal2-faturacartaocredito"' + (opcoes.saj.faturacartaocredito ? ' checked ' : '') + ' style="cursor: pointer;height: 25px;width: 25px;"></span>' +
				'<span class="swal2-label" style=" padding: 10px 0;text-align: right;"> Proposta de abertura de conta</span>' +
				'<span style="text-align: left; padding: 10px 0;"><input type="checkbox" id="swal2-propostaaberturaconta"' + (opcoes.saj.propostaaberturaconta ? ' checked ' : '') + ' style="cursor: pointer;height: 25px;width: 25px;"></span>' +
				'<span class="swal2-label" style=" padding: 10px 0;text-align: right;"> Contrato de Câmbio</span>' +
				'<span style="text-align: left; padding: 10px 0;"><input type="checkbox" id="swal2-contratocambio"' + (opcoes.saj.contratocambio ? ' checked ' : '') + ' style="cursor: pointer;height: 25px;width: 25px;"></span>' +
				'<span class="swal2-label" style=" padding: 10px 0;text-align: right;"> Registro de Câmbio</span>' +
				'<span style="text-align: left; padding: 10px 0;"><input type="checkbox" id="swal2-registrocambio"' + (opcoes.saj.registrocambio ? ' checked ' : '') + ' style="cursor: pointer;height: 25px;width: 25px;"></span>' +
				'<span class="swal2-label" style=" padding: 10px 0;text-align: right;"> Cópia de cheque</span>' +
				'<span style="text-align: left; padding: 10px 0;"><input type="checkbox" id="swal2-copiacheque"' + (opcoes.saj.copiacheque ? ' checked ' : '') + ' style="cursor: pointer;height: 25px;width: 25px;"></span>' +
				'<span class="swal2-label" style="padding: 10px 0;text-align: right;"> Saldos do FGTS e do PIS</span>' +
				'<span style="text-align: left; padding: 10px 0;"><input type="checkbox" id="swal2-saldofgts"' + (opcoes.saj.saldofgts ? ' checked ' : '') + ' style="cursor: pointer;height: 25px;width: 25px;"></span>' +
				'<span class="swal2-label" style="text-align: right;padding: 10px 0 20px 0;"> Receber as notificações de respostas por e-mail</span>' +
				'<span style="text-align: left; padding: 10px 0 20px 0;"><input type="checkbox" id="swal2-recebernotificacao"' + (opcoes.saj.recebernotificacao ? ' checked ' : '') + ' style="cursor: pointer;height: 25px;width: 25px;"></span>' +
				'<span style="font-weight: bold;"> E-mail institucional: </span>' + 
				'<input id="swal-input4" class="swal2-input"" value="' + opcoes.saj.email + '">' +
				'<span style="font-weight: bold;"> Telefone para contato: </span>' + 
				'<input id="swal-input5" class="swal2-input"" value="' + opcoes.saj.telefone + '">' +
				'</div>',
				focusConfirm: false,
				confirmButtonText: 'Salvar',
				width: 800,
			...
			if (resultsaj) {
				opcoes.modulo9.saj = resultsaj[0];
				await guardarModulo9();
				document.getElementById("convenio_saj").style.backgroundColor = (opcoes.modulo9.saj) ? '#2196F3' : '#b0b0b0';
				...
				let var1_saj = browser.storage.local.set({'saj': opcoes.saj});
...
async function guardarModulo9() {
	return new Promise(
		resolver => {
			let var1_modulo9 = browser.storage.local.set({'modulo9': opcoes.modulo9});
			let var1_tempAuto = browser.storage.local.set({'tempAuto': opcoes.tempAuto});
...
async function ativarJuntadaDeMidia() {
	...
	if (document.querySelector('#modulo10_juntadaMidia').checked) {
		...
		if (result) {
			opcoes.modulo10_juntadaMidia = [true,result];
		} else {
			opcoes.modulo10_juntadaMidia = [false,''];
	...
	let var1 = browser.storage.local.set({'modulo10_juntadaMidia': opcoes.modulo10_juntadaMidia});
	Promise.all([var1]).then(values => {
		let Toast = Swal.mixin({
			toast: true,
			position: 'bottom-end',
...
async function importarAA() {
	...
	const { value: result } = await Swal.fire({
		...
		'<i style="font-size: 0.8em;font-weight: normal;font-style: normal;text-align: left;color: darkcyan;">Coleque uma configuração em cada campo. É possível importar no máximo cinco ações por vez.</i><br>' +
		...
		if (result) {
			...
			switch (this.id) {
				...
				case 'aa_imp_comunicacao':		
					...
					for (var i = 0; i < colecao.length; i++) {		
						let temp = JSON.parse(colecao[i]);							
						criaBotao_aaComunicacao(aaComunicacao_temp.length, temp.nm_botao, temp.tipo, temp.subtipo, temp.tipo_prazo, temp.prazo, temp.descricao, temp.sigilo, temp.modelo, temp.salvar, temp.cor, temp.vinculo, temp.fluxo, temp.visibilidade);
						aaComunicacao_temp.push(new AcaoAutomatizada_aaComunicacao(temp.nm_botao, temp.tipo, temp.subtipo, temp.tipo_prazo, temp.prazo, temp.descricao, temp.sigilo, temp.modelo, temp.salvar, temp.cor, temp.vinculo, temp.fluxo, temp.visibilidade));
					}						
					break;
				...
				case 'aa_imp_despacho':
					...
					for (var i = 0; i < colecao.length; i++) {
						...
						criaBotao_aaDespacho(aaDespacho_temp.length, temp.nm_botao, temp.tipo, temp.descricao, temp.sigilo, temp.modelo, temp.juiz, temp.responsavel, tempAssinar, temp.cor, temp.vinculo, temp.visibilidade);
						aaDespacho_temp.push(new AcaoAutomatizada_aaDespacho(temp.nm_botao, temp.tipo, temp.descricao, temp.sigilo, temp.modelo, temp.juiz, temp.responsavel, tempAssinar, temp.cor, temp.vinculo, temp.visibilidade));
					}
...
async function montarBotoesaaComunicacao() {	
	if (typeof(aaComunicacao_temp) != "undefined") {
		...
		for (const [pos, item] of aaComunicacao_temp.entries()) {
			...
			aa = new AcaoAutomatizada_aaComunicacao(aa.nm_botao, aa.tipo, aa.subtipo, aa.tipo_prazo, aa.prazo, aa.descricao, aa.sigilo, aa.modelo, aa.salvar, aa.cor, aa.vinculo, aa.fluxo, (!aa.visibilidade?'sim':aa.visibilidade));
			ajustandoLista.push(aa);
			
			criaBotao_aaComunicacao(pos, aa.nm_botao, aa.tipo, aa.subtipo, aa.tipo_prazo, aa.prazo, aa.descricao, aa.sigilo, aa.modelo, aa.salvar, aa.cor, aa.vinculo, aa.fluxo, aa.visibilidade);
...
async function montarBotoesaaDespacho() {
	if (typeof(aaDespacho_temp) != "undefined") {
		...
		for (const [pos, item] of aaDespacho_temp.entries()) {
			...
			//insere a visibilidade dentro da AA ajusatando todos as ações			
			//AcaoAutomatizada_aaDespacho(nm_botao, tipo, descricao, sigilo, modelo, juiz, responsavel, assinar, cor, vinculo, visibilidade='sim')
			
			let tempAssinar = (!aa.assinar) ? 'não' : aa.assinar;
			
			aa = new AcaoAutomatizada_aaDespacho(aa.nm_botao, aa.tipo, aa.descricao, aa.sigilo, aa.modelo, aa.juiz, aa.responsavel, tempAssinar, aa.cor, aa.vinculo, (!aa.visibilidade?'sim':aa.visibilidade));
			ajustandoLista.push(aa);
			
			criaBotao_aaDespacho(pos, aa.nm_botao, aa.tipo, aa.descricao, aa.sigilo, aa.modelo, aa.juiz, aa.responsavel, tempAssinar, aa.cor, aa.vinculo, aa.visibilidade);
...
function montarAtalhosPlugin() {
	opcoes.atalhosPlugin = document.getElementById("atalhosPlugin").value.replace(/(\r\n|\n|\r)/gm, "|");
	return opcoes.atalhosPlugin;
}
...
function montarFiltrosFavoritos(ancora) {
	...
	filtros_storage = opcoes.filtros_Favoritos;
	...
	document.querySelector('#modulo5_filtros_favoritos_ObterSaldoSIf').checked = opcoes.modulo5_obterSaldoSIF;
	document.querySelector('#modulo5_filtros_favoritos_ObterSaldoSIf').addEventListener('click', salvarOpcoes);
	document.querySelector('#modulo5_filtros_favoritos_juizDaMinuta').checked = opcoes.modulo5_juizDaMinuta;
...
function criaBotao_aaComunicacao(id, nm_botao, tipo, subtipo, tipo_prazo, prazo, descricao, sigilo, modelo, salvar, cor, vinculo, fluxo, visibilidade) {
...
function criaBotao_aaDespacho(id, nm_botao, tipo, descricao, sigilo, modelo, juiz, responsavel, assinar, cor, vinculo, visibilidade) {
	//ajustar o vinculo para aum array
	vinculo = Array.isArray(vinculo) ? vinculo : vinculo.split(',');
	...
	a.onclick = function (e) {
		...
		if (e.ctrlKey) { //ativa/desativa a visibilidade
			let v = (visibilidade.toLowerCase() == "sim") ? "não" : "sim";
			aaDespacho_temp[id] = new AcaoAutomatizada_aaDespacho(nm_botao, tipo, descricao, sigilo, modelo, juiz, responsavel, assinar, cor, vinculo, v);
			salvarOpcoes();
			document.getElementById("botoes_despacho").textContent = '';
			montarBotoesaaDespacho();
...
function listaAcoesAutomatizadas(vinculo) {
	...
	teste = [].map.call(opcoes.aaLancarMovimentos,function(item) {
...
async function modalEditorEditar(elemento_pai, tipo, id) {
	if (tipo == "anexar") {
		let regraDoSigilo = 0;		
		regraDoSigilo = (aaAnexar_temp[id].sigilo.includes('Polo Ativo') && aaAnexar_temp[id].sigilo.includes('Polo Passivo')) ? 3 : regraDoSigilo;
		regraDoSigilo = (regraDoSigilo == 0 && aaAnexar_temp[id].sigilo.includes('Polo Ativo')) ? 1 : regraDoSigilo;
		regraDoSigilo = (regraDoSigilo == 0 && aaAnexar_temp[id].sigilo.includes('Polo Passivo')) ? 2 : regraDoSigilo;
		...
		const { value: result } = await Swal.fire({
			...
			'<select id="swal-input4-1" class="swal2-select" style="background-color: white;width: 49%;border: 1px solid #d9d9d9;border-radius: 0 .1875em .1875em 0;box-shadow: inset 0 1px 1px rgba(0,0,0,.06);height: 2.625em;padding: 0 .75em;border-left: 0;">' + 
				...
				'<option value="Polo Ativo"' + (regraDoSigilo==1 ? 'selected' : '') + '> Polo Ativo </option>' + 
				'<option value="Polo Passivo"' + (regraDoSigilo==2 ? 'selected' : '') + '> Polo Passivo </option>' + 
				'<option value="Ambos"' + (regraDoSigilo==3 ? 'selected' : '') + '> Ambos </option>' + 
				'</optgroup>' +
			'</select><br>' +
		...
		const { value: result } = await Swal.fire({
			title: '    ',
			html:
			'<span style="font-weight: bold;"> Nome do Botão <br><i style="font-size: 0.8em;font-weight: normal;font-style: normal;text-align: left; color: darkcyan;"><br>aceita a expressão <b>[ativo;passivo;terceiros;assinar]</b> que irá escolher para você o polo ativo, o polo passivo, os terceiros interessados e/ou, ainda, clicar no botão assinar ao final da escolha.</i></span>' + 
			'<input id="swal-input1" class="swal2-input" value="' + aaComunicacao_temp[id].nm_botao + '">' +
		...
		function texto_html() {
			...
			switch (aaAutogigs_temp[id].tipo) {					
				...
				default:					
					...
					'<input id="swal-input3" class="swal2-input" value="' + aaAutogigs_temp[id].tipo_atividade + '">' +
					'<span style="font-weight: bold;"> Prazo <br><i style="font-size: 0.8em;font-weight: normal;font-style: normal;text-align: left; color: darkcyan;"><br>aceita a expressão <b>[data_audi]</b> que irá preencher o campo com a data da audiência do processo.</i></span>' + 
					...
					'<span style="font-weight: bold;"> Responsável pelo processo </span>' + 
					'<input id="swal-input6" class="swal2-input" value="' + aaAutogigs_temp[id].responsavel_processo + '">' +
					'<span style="font-weight: bold;"> Observação <br><i style="font-size: 0.8em;font-weight: normal;font-style: normal;text-align: left;color: darkcyan;"><br>aceita a expressão <b>"perguntar"</b> e <b>"corrigir data"</b> que interrompe a ação para o usuário informar o que quer preencher no campo</i><br><br><i style="font-size: 0.8em;font-weight: normal;font-style: normal;text-align: left; color: darkcyan;"><br>aceita também as expressões <b>[data_audi]</b> <b>[dados_audi]</b> <b>[link_audi]</b>, que irão ser substituídas no campo observação, respectivamente, pela data da audiência, pelos dados da audiência e pelo link da audiência, se houver.</i><br></span>' + 
					'<textarea id="swal-input7" class="swal2-textarea">' + aaAutogigs_temp[id].observacao + '</textarea>' +
					'<span style="font-weight: bold;"> Salvar </span>' + 
					'<br><select id="swal-input8" class="swal2-select" style="background-color: white;width: 100%;border: 1px solid #d9d9d9;border-radius: .1875em;box-shadow: inset 0 1px 1px rgba(0,0,0,.06);height: 2.625em;padding: 0 .75em;">' + 
						'<option value="nao"' + (aaAutogigs_temp[id].salvar.toLowerCase().includes('nao') ? 'selected' : '')  + '> Não </option>' + 
		...
		let padrao1 = /(?:prazo:){1}\d{1,}/g;
		let padrao2 = /(?:movimento:){1}\d{1,}/g;
		let avancadoPrazo = '';
		let avancadoMovimento = '';
		if (padrao1.test(aaDespacho_temp[id].nm_botao)) {
			avancadoPrazo = aaDespacho_temp[id].nm_botao.match(padrao1).join();
			avancadoPrazo = avancadoPrazo.replace('prazo:','');
		}
		if (padrao2.test(aaDespacho_temp[id].nm_botao)) {
			avancadoMovimento = aaDespacho_temp[id].nm_botao.match(padrao2).join();
			avancadoMovimento = avancadoMovimento.replace('movimento:','');
		}
		...
		const { value: result } = await Swal.fire({
			...
			'<input id="swal-input0" class="swal2-input" value="' + aaDespacho_temp[id].nm_botao + '">' +
			...
			'<br><br><label class="container">' +
			'<input type="checkbox" id="swal-input9" ' + (aaDespacho_temp[id].visibilidade.toLowerCase().includes('sim') ? 'checked' : '') + '><span style="position: relative; padding-right: 15px; top: 2px; margin-left: -10px; font-weight: bold;">Visível na Janela Detalhes?</span>' +
			'<span class="checkmark"></span>' +
			...
			preConfirm: () => {
				return [
					document.getElementById('swal-input0').value, //nm_botao
					...
					document.getElementById('swal-input9').checked ? "sim" : "não", //visibilidade
					document.getElementById('swal-input_vinculo')?.value, //vinculo
		...
		if (result) {
			//AcaoAutomatizada_aaDespacho(nm_botao, tipo, descricao, sigilo, modelo, juiz, responsavel, assinar, cor, vinculo, visibilidade='sim')
			aaDespacho_temp[id] = new AcaoAutomatizada_aaDespacho(result[0], result[1], result[2], result[3], result[4], result[5], result[6], result[7], result[8], result[10], result[9]);
			salvarOpcoes();
			document.getElementById("botoes_despacho").textContent = '';
			montarBotoesaaDespacho();
		}
...
async function salvarConfig() {
	...
	Promise.all([limpar_residuos]).then(async values => {
		...
		const { value: result } = await Swal.fire({
			...
			'<textarea id="swal-input1" class="swal2-input" style="height: 500px;font-family: inherit;line-height: 1.5em;margin:0;">***' + new Date().toLocaleDateString() + '***' + JSON.stringify(opcoes) + '</textarea>',
...
document.getElementById("titulo_email").addEventListener('focusout', function(event) {
	emailAutomatizado_temp.titulo = document.getElementById("titulo_email").value;
	salvarOpcoes();
});

document.getElementById("corpo_email").addEventListener('focusout', function(event) {
	emailAutomatizado_temp.corpo = document.getElementById("corpo_email").value;
	salvarOpcoes();
});

document.getElementById("assinatura_email").addEventListener('focusout', function(event) {
	emailAutomatizado_temp.assinatura = document.getElementById("assinatura_email").value;
	salvarOpcoes();
});
...
document.body.addEventListener("click", async function (event) {	
	...
	if (id_elemento) {
		if (id_elemento.includes('menu_atalho_')) {
			id_elemento = id_elemento.replace('menu_atalho_','');
			document.getElementById(id_elemento).scrollIntoView({behavior: 'auto',block: 'start',inline: 'center'});
		}
...
function AcaoAutomatizada_aaComunicacao(nm_botao, tipo, subtipo, tipo_prazo, prazo, descricao, sigilo, modelo, salvar, cor, vinculo, fluxo, visibilidade='sim') {
	this.nm_botao = nm_botao;
	this.tipo = tipo;
...
function AcaoAutomatizada_aaDespacho(nm_botao, tipo, descricao, sigilo, modelo, juiz, responsavel, assinar, cor, vinculo, visibilidade='sim') {
	this.nm_botao = nm_botao;
	this.tipo = tipo;
	this.descricao = descricao;
	this.sigilo = sigilo;
